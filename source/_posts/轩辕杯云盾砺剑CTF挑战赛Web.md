...
简单的js，我们在开发者工具中发现main.js![](http://xendria.icu/wp-content/uploads/2025/05/939759a9-2d73-4457-a9c1-267c0454c57f.png)进入/getflag.php，然后POST改score就行![](http://xendria.icu/wp-content/uploads/2025/05/c4b8de3a-4f36-45f5-8e46-d5921623ecef.png)
...
注意到这个是in_array()函数检测，我们可以用" \ "来绕过其的检测![](http://xendria.icu/wp-content/uploads/2025/05/ddd8efc6-6ee5-4749-9fc6-71a9947a924f.png)后面就能自由命令执行了。
...
我们观察这个代码，对于输入的参数url进行检测，要求为http头，然后域名为null我们就可以构造了![](http://xendria.icu/wp-content/uploads/2025/05/005d0933-735e-40d6-9056-64687ffef9d8.png)访问此路由即可得flag
...
![](http://xendria.icu/wp-content/uploads/2025/05/e4913759-3eb0-4f3a-92fb-e48972adf91b-1024x422.png)

这借着下去是个假flag

![](http://xendria.icu/wp-content/uploads/2025/05/bdb15274-5051-4001-8ad9-ebf9cd5f6785.png)

我们重新找数据库

![](http://xendria.icu/wp-content/uploads/2025/05/71f91403-2ca1-408f-8daa-99ecc445c8bc.png)

这个才是对的，然后就是接着的一系列套公式操作

<div class="wp-block-group">
![](http://xendria.icu/wp-content/uploads/2025/05/5f38c1f4-12a4-47db-8cc1-f5ab926e1877-1024x501.png)
...
![](http://xendria.icu/wp-content/uploads/2025/05/0d964c71-24da-4cf7-8d94-0abe33e896a4-1024x566.png)

这三都可以进行非预期

![](http://xendria.icu/wp-content/uploads/2025/05/720da359-8f6d-47a8-9c36-01ff5d803d06-1024x390.png)

![](http://xendria.icu/wp-content/uploads/2025/05/6bcb25a4-ac47-40ff-81d1-17313f2a5c33-1024x468.png)

![](http://xendria.icu/wp-content/uploads/2025/05/9641c2a1-2761-449b-8a19-f52dccce1c20-1024x465.png)

| 特性 | /proc/self/environ | /proc/1/environ |
| --- | --- | --- |
| 目标进程 | 当前进程（调用它的进程） | PID=1 的初始化进程（如systemd） |
...
cookie有个jwt，而且根据源码我们也知道了要jwt伪造admin，那key在哪呢？在环境变量里，可见上面的../..`/proc/self/environ`key=th1s_1s_k3ytoken=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFkbWluIn0.EYrwzSGzfGe_PMnw-Wl4Ymt_QuMtyApHi57DMcZ7e3U然后我们观察到这段代码
...
![](http://xendria.icu/wp-content/uploads/2025/05/8e83faf9-c322-4192-8ebf-0da8d6b38d2c-1024x466.png)
