...
第一层的强比较可以用数组绕过apple[]=1&banana[]=2然后第二层的弱比较可以用两个经过md5后开头为0e的来绕过第三层的强比较我们可以使用 fastcoll 工具，碰撞出一个值来绕过第四层运用到了md5的长度扩展攻击，这玩意感觉挺复杂的，但是网上能找到工具[https://github.com/luoingly/attack-scripts/blob/main/logic/md5-extension-attack.py](https://github.com/luoingly/attack-scripts/blob/main/logic/md5-extension-attack.py)就是说通过一个已知哈希值 Hash 和消息长度 len(Msg) 的哈希值时，我们能利用其复现出大致的加密过程，然后我们利用这个的过程重新生成一个附加了新数据的md5值哈希值在我们绕过第三层的时候会给我们，消息长度和我们需要的附加值的话我们看到这里
...
![](http://xendria.icu/wp-content/uploads/2025/06/cc922cac-6c45-41b5-8f41-9ae04d09fd19-1024x188.png)

![](http://xendria.icu/wp-content/uploads/2025/06/c575db54-19c6-498c-8cd7-184887bc8c33-1024x511.png)

记得把cookie改为绕过第三层时的PHPSESSID（栽这半天了

```
payload：
apple[]=1&banana[]=2&appple=byGcY&bananana=QNKCDZO&apppple=%4d%c9%68%ff%0e%e3%5c%20%95%72%d4%77%7b%72%15%87%d3%6f%a7%b2%1b%dc%56%b7%4a%3d%c0%78%3e%7b%95%18%af%bf%a2%00%a8%28%4b%f3%6e%8e%4b%55%b3%5f%42%75%93%d8%49%67%6d%a0%d1%55%5d%83%60%fb%5f%07%fe%a2&banananana=%4d%c9%68%ff%0e%e3%5c%20%95%72%d4%77%7b%72%15%87%d3%6f%a7%b2%1b%dc%56%b7%4a%3d%c0%78%3e%7b%95%18%af%bf%a2%02%a8%28%4b%f3%6e%8e%4b%55%b3%5f%42%75%93%d8%49%67%6d%a0%d1%d5%5d%83%60%fb%5f%07%fe%a2&name=%80%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%00%03%00%00%00%00%00%00admin&md5=生成的值
```
...
if (sizeof($_POST['len']) == sizeof($array)) {
  ...
  die("错了！就你还想玩原神？❌❌❌");
}//这是是要检查$_POST['len']数组的长度是否与$array数组的长度相同，然后就能调用这个函数继续走下去
```

然后就是在ys_open里要满足$tip == "我要玩原神"
...
![](http://xendria.icu/wp-content/uploads/2025/06/5545fa44c2333d3574baa0888dab8d5b-1024x624.png)
...
需要我们通过逆向给的数据还原出flag，我们直接模仿他的操作然后匹配flag字符就好了
...
有两个路由一个/flag ，一个index。我们先看看![](http://xendria.icu/wp-content/uploads/2025/06/a1c3787b-6cc0-4c5d-abf0-3a283f45af79.png)![](http://xendria.icu/wp-content/uploads/2025/06/a63cba62-9367-45c1-9550-38c0eb74b065.png)

![](http://xendria.icu/wp-content/uploads/2025/06/b9ffbf01-70e2-4c8d-b4e4-895108e58bb0.png)

我们把lucky_number爆破出来获得部分源码
...
emm，我们看到了过滤了{}，我们可以利用原型污染把这个全局变量BLACKLIST_IN_index = ['{','}']改了
